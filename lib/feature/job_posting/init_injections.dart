...
import 'package:withu/feature/job_posting/job_posting.dart';
import 'package:withu/feature/job_posting/presentation/blocs/workers/job_posting_workers_bloc.dart';
...
initJobPostingInjections() {
  ...
  getIt.registerFactory<JobPostingsTabBloc>(() => JobPostingsTabBloc());
