...
import 'package:withu/feature/user/presentation/presentation.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        Stack(
          children: [
            UserProfile(profile: profile, name: name, age: age),
            Positioned(
              top: 5,
              right: 5,
              child: BaseBadge(
        ...
        _WorkTime(startTime: startTime, endTime: endTime),
      ],
    );
  }
}
...
class _WorkTime extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          Text(StringRes.attendance.tr, style: context.textTheme.bodySmall),
          Expanded(
            child: Text(
          ...
          Text(StringRes.leaveWork.tr, style: context.textTheme.bodySmall),
          Expanded(
            child: Text(
